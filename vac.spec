...
mkdir -p $RPM_BUILD_ROOT/usr/man/man1 $RPM_BUILD_ROOT/usr/man/man5 $RPM_BUILD_ROOT/usr/man/man8
cp -f $RPM_BUILD_ROOT/var/lib/vac/doc/vac.1 $RPM_BUILD_ROOT/usr/man/man1
